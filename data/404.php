		...
		<section class="section fullwidth-page bg-gradient-3">
			<div class="fullwidth-page-inner">
				<div class="section-md text-center">
					<div class="container">
						<p class="breadcrumbs-custom-subtitle">Sorry, But the Page Was not Found
						</p>
						<p class="heading-1 breadcrumbs-custom-title">error 404
						</p>
						<p>You may have mistyped the address or the page may have moved.
						</p>
						<a class="button button-secondary button-nina" href="index.php"><span style="transition: opacity 0.22s ease 0s, transform 0.22s ease 0s, color 0.22s ease 0s;"></span><span style="transition: opacity 0.22s ease 0.03s, transform 0.22s ease 0.03s, color 0.22s ease 0s;">b</span><span style="transition: opacity 0.22s ease 0.06s, transform 0.22s ease 0.06s, color 0.22s ease 0s;">a</span><span style="transition: opacity 0.22s ease 0.09s, transform 0.22s ease 0.09s, color 0.22s ease 0s;">c</span><span style="transition: opacity 0.22s ease 0.12s, transform 0.22s ease 0.12s, color 0.22s ease 0s;">k</span><span style="transition: opacity 0.22s ease 0.15s, transform 0.22s ease 0.15s, color 0.22s ease 0s;"></span><span style="transition: opacity 0.22s ease 0.18s, transform 0.22s ease 0.18s, color 0.22s ease 0s;">t</span><span style="transition: opacity 0.22s ease 0.21s, transform 0.22s ease 0.21s, color 0.22s ease 0s;">o</span><span style="transition: opacity 0.22s ease 0.24s, transform 0.22s ease 0.24s, color 0.22s ease 0s;"></span><span style="transition: opacity 0.22s ease 0.27s, transform 0.22s ease 0.27s, color 0.22s ease 0s;">h</span><span style="transition: opacity 0.22s ease 0.3s, transform 0.22s ease 0.3s, color 0.22s ease 0s;">o</span><span style="transition: opacity 0.22s ease 0.33s, transform 0.22s ease 0.33s, color 0.22s ease 0s;">m</span><span style="transition: opacity 0.22s ease 0.36s, transform 0.22s ease 0.36s, color 0.22s ease 0s;">e</span><span style="transition: opacity 0.22s ease 0.39s, transform 0.22s ease 0.39s, color 0.22s ease 0s;"></span><span style="transition: opacity 0.22s ease 0.42s, transform 0.22s ease 0.42s, color 0.22s ease 0s;">p</span><span style="transition: opacity 0.22s ease 0.45s, transform 0.22s ease 0.45s, color 0.22s ease 0s;">a</span><span style="transition: opacity 0.22s ease 0.48s, transform 0.22s ease 0.48s, color 0.22s ease 0s;">g</span><span style="transition: opacity 0.22s ease 0.51s, transform 0.22s ease 0.51s, color 0.22s ease 0s;">e</span><span class="button-original-content" style="transition: background 0.22s ease 0s, color 0.22s ease 0s, transform 0.22s ease 0.54s;">back to home page</span></a>
					</div>
				</div>
				<!-- Page Footer-->

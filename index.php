...
<head>
	<!-- Site Title-->
	<title>Create With BUDDY | Get Ready
	</title>
	<meta charset="utf-8"/>
	...
	<div class="page">
		...
		<section class="section fullwidth-page bg-gradient-3">
			<div class="fullwidth-page-inner">
				<div class="section-md text-center" style="margin-top: -50px;">
					<div class="container-wide">
						<p class="breadcrumbs-custom-subtitle">We're Getting Ready to Launch In
						</p>
						<div class="countdown-wrap">
							<div class="DateCountdown time-circles" data-countdown="data-countdown" data-to="2020-12-31">
								<div class="countdown-block countdown-block-days">
									<svg class="countdown-circle" data-progress-days="" height="200" viewbox="0 0 200 200" width="200" x="0" y="0">
										<circle class="countdown-circle-bg" cx="100" cy="100" r="68">
										</circle>
										<circle class="countdown-circle-fg clipped" cx="100" cy="100" r="78">
										</circle>
									</svg>
									<div class="countdown-content">
										<div id="days_time" class="countdown-counter" data-counter-days="">
										</div>
										<div class="countdown-title">days
										</div>
									</div>
								</div>
								<div class="countdown-block countdown-block-hours">
									<svg class="countdown-circle" data-progress-hours="" height="200" viewbox="0 0 200 200" width="200" x="0" y="0">
										<circle class="countdown-circle-bg" cx="100" cy="100" r="68">
										</circle>
										<circle class="countdown-circle-fg clipped" cx="100" cy="100" r="78">
										</circle>
									...
									<div class="countdown-content">
										<div id="hours_time" class="countdown-counter" data-counter-hours="">
										</div>
										<div class="countdown-title">hours
										</div>
									</div>
								</div>
								<div class="countdown-block countdown-block-minutes">
									<svg class="countdown-circle" data-progress-minutes="" height="200" viewbox="0 0 200 200" width="200" x="0" y="0">
										<circle class="countdown-circle-bg" cx="100" cy="100" r="68">
										</circle>
										<circle class="countdown-circle-fg clipped" cx="100" cy="100" r="78">
										</circle>
									...
									<div class="countdown-content">
										<div id="mins_time" class="countdown-counter" data-counter-minutes="">
										</div>
										<div class="countdown-title">minutes
										</div>
									</div>
								</div>
								<div class="countdown-block countdown-block-seconds">
									<svg class="countdown-circle" data-progress-seconds="" height="200" viewbox="0 0 200 200" width="200" x="0" y="0">
										<circle class="countdown-circle-bg" cx="100" cy="100" r="68">
										</circle>
										<circle class="countdown-circle-fg clipped" cx="100" cy="100" r="78">
										</circle>
									...
									<div class="countdown-content">
										<div id="secs_time" class="countdown-counter" data-counter-seconds="">
										</div>
										<div class="countdown-title">seconds
										</div>
									</div>
								</div>
							</div>
						...
						<!-- <p>Our website is coming soon and we are currently working very hard 
							<br class="d-none d-md-inline"/>to give you the best experience on our new website.
						</p> -->
						<br>
...
var countDownDate = new Date("Nov 23, 2020 14:29:00").getTime();
...
var x = setInterval(function() {
  ...
  // + minutes + "m " + seconds + "s ";
    document.getElementById("days_time").innerHTML = days;
    document.getElementById("hours_time").innerHTML = hours;
    document.getElementById("mins_time").innerHTML = minutes;
    document.getElementById("secs_time").innerHTML = seconds;
